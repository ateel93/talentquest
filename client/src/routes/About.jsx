function About () {
    return(
        ...
        <div>
            ...
            <h3 class="text-gray-500 pb-2">We prioritize user experience in everything we do. Our platform is designed with candidates in mind, ensuring a user-friendly interface that simplifies the job search journey.</h3>
        </div>
        </div>
    )
}
