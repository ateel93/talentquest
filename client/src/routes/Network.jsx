        ...
        <div>
          ...
          <div className="pb-2">
            ...
            <div className="flex flex-wrap overflow-auto max-h-96 px-1.5">
                {newSearch.map(user => (<div className="flex justify-end px-4 pt-4 w-60 max-w-sm bg-blue-100 border border-gray-200 hover:bg-blue-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
